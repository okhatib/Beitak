...
public class LoginActivity extends Activity {
	/**
	 * A dummy authentication store containing known use
	 * r names and passwords.
	...
	public void attemptLogin() {
		...
		if (cancel) {
			...
			Intent i = new Intent(this, ItemsFeedActivity.class);
			startActivity(i);
			finish();
		}
	}
...
//				
//				int id = login.getByUsernameAndPassword(mName, mPassword);
//				if (id == -1)
//				{
//					return false;
//				}else{
